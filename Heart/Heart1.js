...
class Heart1 extends Component {
    ...
    static navigationOptions = ({ navigation }) => ({
        headerTitle:<View style={styles.headerTitle}>
          ...
          <Text style={styles.text}>Chứng ngưng tim đột ngột</Text>
        </View>,
        ...
        >
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  ...
                  Chứng ngưng tim đột ngột xảy ra không báo trước và thường không có dấu hiệu cảnh báo.
                  </Text>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  ...
                  <View style={{justifyContent: 'center', marginTop: '15%'}}>
                        ...
                        style={styles.button}>
                            <View>
                                <Text style={styles.text}>Hồi sinh tim phổi CPR</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
