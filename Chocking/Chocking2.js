...
var list = [
  {
    id: 0,
    name: 'chocking2_1.mp3'
  },
  {
    id: 1,
    name: 'chocking2_2.mp3'
  },
]
...
class Chocking2 extends Component {
    ...
    static navigationOptions = ({ navigation }) => ({
        headerTitle:<View style={styles.headerTitle}>
          ...
          <Text style={styles.text}>Hóc - Tự ho được</Text>
        </View>,
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('chocking2_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              <View style={{justifyContent: 'center', alignItems: 'center'}} onLayout={this.onPressButtonPlay}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/chocking2.gif')}/>
                  <Text style={styles.semiButtonText}>
                  Nếu nạn nhân có thể ho, thì họ có thể thở được, nên khuyến khích họ ho thêm.
                  </Text>
                  <Text style={styles.semiButtonText}>
