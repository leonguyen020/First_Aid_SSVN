...
//   },
  {
    id: 0,
    name: 'chocking4_1.mp3'
  },
  {
    id: 1,
    name: 'chocking4_2.mp3'
  },
]

class Chocking4 extends Component {
    
    static navigationOptions = ({ navigation }) => ({
        headerTitle:<View style={styles.headerTitle}>
          <Text style={styles.buttonText}>HÓC</Text>
          <Text style={styles.text}>Xử lý hóc dị vật đối với trẻ sơ sinh</Text>
        </View>,
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('chocking4.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                song.play(()=> song = new SoundPlayer('chocking4_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              <View style={{justifyContent: 'center', alignItems: 'center'}} onLayout={this.onPressButtonPlay}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/chocking4_1.gif')}/>
                  <Text style={styles.semiButtonText}>
                  Dùng tay đở cổ, mở đường thở cho trẻ. Đặt trẻ nằm sấp trên gối, 
                  đầu hơi chúc xuống. Dùng lòng bàn tay vỗ với cường độ vừa phải vào vùng xương 
                  giữa 2 bả vai hướng lên gáy.
                  </Text>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/chocking4_2.gif')}/>
                  <Text style={styles.semiButtonText}>
                  Dùng lòng bàn tay vỗ 5 cái dứt khoát vào vùng xương giữa 2 bả vai. 
                  Sau đó, dùng 2 ngón tay ấn 5 lần vào giữa ngực trẻ. Nếu trẻ có dấu hiệu ho, 
                  ngay lập tức dừng lại để trẻ tự ho. Trẻ ho được nghĩa là trẻ thở được.
                  </Text>
