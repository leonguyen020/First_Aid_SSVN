...
var list = [
  {
    id: 0,
    name: 'bleeding5_1.mp3'
  },
  {
    id: 1,
    name: 'bleeding5_2.mp3'
  },
  {
    id: 2,
    name: 'bleeding5_3.mp3'
  },
]
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('bleeding5.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                song.play(()=> song = new SoundPlayer('bleeding5_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}} onLayout={this.onPressButtonPlay}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/bleeding5_1.gif')}/>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/bleeding5_2.gif')}/>
                  <Text style={styles.semiButtonText}>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/bleeding5_3.gif')}/>
                  <Text style={styles.semiButtonText}>
