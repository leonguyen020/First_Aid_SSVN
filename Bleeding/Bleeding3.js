...
//   },
  {
    id: 0,
    name: 'bleeding3_11.mp3'
  },
  {
    id: 1,
    name: 'bleeding3_12.mp3'
  },
  {
    id: 2,
    name: 'bleeding3_13.mp3'
  },
]
...
class Bleeding3 extends Component {
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('bleeding3_11.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image}/>
                  <Text style={styles.semiButtonText}>
                  Sau đó dùng băng thun quấn chặt vết thương để tạo áp lực cầm máu. 
                  Nếu thấy máu đỏ tươi thấm qua lớp băng bó, không tháo bỏ lớp băng đó ra mà thêm băng gạc 
                  áp tròng lên phía trên và tạo thêm áp lực cầm máu.
                  </Text>
