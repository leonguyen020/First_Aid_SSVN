...
//   },
  {
    id: 0,
    name: 'bleeding7_1.mp3'
  },
  {
    id: 1,
    name: 'bleeding7_2.mp3'
  },
]

class Bleeding7 extends Component {
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('bleeding7.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                song.play(()=> song = new SoundPlayer('bleeding7_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
