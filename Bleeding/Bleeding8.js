...
//   },
  {
    id: 0,
    name: 'bleeding8_1.mp3'
  },
  {
    id: 1,
    name: 'bleeding8_2.mp3'
  },
  {
    id: 2,
    name: 'bleeding8_3.mp3'
  },
]

class Bleeding8 extends Component {
    
    static navigationOptions = ({ navigation }) => ({
        headerTitle:<View style={styles.headerTitle}>
          <Text style={styles.buttonText}>CHẢY MÁU</Text>
          <Text style={styles.text}>Đâm vào mắt</Text>
        </View>,
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('bleeding8.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                song.play(()=> song = new SoundPlayer('bleeding8_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              <View style={{justifyContent: 'center', alignItems: 'center'}} onLayout={this.onPressButtonPlay}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/bleeding8_1.gif')}/>
                  <Text style={styles.semiButtonText}>
                  Không lấy dị vật ra.
                  </Text>
                  <Text style={styles.semiButtonText}>
                  Dùng vải cuộn thành khoanh tròn.
                  </Text>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/bleeding8_2.gif')}/>
                  <Text style={styles.semiButtonText}>
                  Sau đó đặt xung quanh mắt bị thương của nạn nhân.
                  </Text>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/bleeding8_3.gif')}/>
                  <Text style={styles.semiButtonText}>
                  Dùng băng thun quấn quanh đầu để cố định cuộn vải ở mắt. Chừa tầm nhìn 
                  cho mắt còn lại và yêu cầu nạn nhân hạn chế di chuyển 2 mắt.
                  </Text>
