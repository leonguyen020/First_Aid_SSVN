...
var list = [
  {
    id: 0,
    name: 'bleeding4_1.mp3'
  },
  {
    id: 1,
    name: 'bleeding4_2.mp3'
  },
  {
    id: 2,
    name: 'bleeding4_3.mp3'
  },
]
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('bleeding4.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                song.play(()=> song = new SoundPlayer('bleeding4_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image}/>
                  <Text style={styles.semiButtonText}>
                  Dùng gạc thấm nước, gạc không dúng hoặc vải sạch có thấm nước che vết thương.
                  </Text>
