...
class Drown1 extends Component {
    ...
    // onPressButtonPlay() {
    //     if(song == null){
    //         song = new SoundPlayer('drown1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
    //             song.play(()=> song = new SoundPlayer('drown1_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                ...
                <View style={styles.slide1}>
                  <Text style={styles.buttonText}>TÌNH TRẠNG HIỆN TẠI CỦA NẠN NHÂN?</Text>
                    ...
                    <View style={{flexDirection:'row', marginTop: '15%'}}>
                        ...
                        style={styles.button}>
                            <View>
                                <Text style={styles.text}>Còn Thở</Text>
                            </View>
                        </TouchableOpacity>
                        ...
                        style={styles.button}>
                            <View>
                                <Text style={styles.text}>Không còn thở</Text>
                            </View>
                        </TouchableOpacity>
                    </View>
                </View>
