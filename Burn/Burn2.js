...
class Burn2 extends Component {
    
    static navigationOptions = ({ navigation }) => ({
        headerTitle:<View style={styles.headerTitle}>
          <Text style={styles.buttonText}>BỎNG/PHỎNG</Text>
          <Text style={styles.text}>Xử lý sơ cứu bỏng</Text>
        </View>,
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('burn2.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                song.play(()=> song = new SoundPlayer('burn2_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                  song.play(()=> song = new SoundPlayer('burn2_2.mp3', SoundPlayer.MAIN_BUNDLE, () => {
