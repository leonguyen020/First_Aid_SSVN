...
class Unconscious12 extends Component {
    ...
    //             song.play(()=> song = new SoundPlayer('unconscious4.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  ...
                  với các ngóc tay song song với xương sườn.
                  </Text>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  ...
                  sâu khoảng 1/3 chiều sâu lồng ngực với nhịp độ 100 lần/phút.
                  </Text>
