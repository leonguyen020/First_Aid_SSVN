...
var list = [
  ...
  {
    id: 0,
    name: 'unconscious7_1.mp3'
  },
  {
    id: 1,
    name: 'unconscious7_2.mp3'
  },
]

class Unconscious7 extends Component {
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('unconscious7.mp3', SoundPlayer.MAIN_BUNDLE, () => {
                song.play(()=> song = new SoundPlayer('unconscious7_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              <View style={{justifyContent: 'center', alignItems: 'center'}} onLayout={this.onPressButtonPlay}>
                <View style={styles.slide1}>
                  ...
                  Nạn nhân bất tỉnh, còn thở ở tư thế phức tạp
                  </Text>
