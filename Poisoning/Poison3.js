...
class Poison3 extends Component {
    
    static navigationOptions = ({ navigation }) => ({
        headerTitle:<View style={styles.headerTitle}>
          <Text style={styles.buttonText}>NHIỄM ĐỘC</Text>
          <Text style={styles.text}>Nhiễm độc - Bị tiêm vào trong</Text>
        </View>,
        ...
        >
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  ...
                  Quấn chặt khu vưc bị cắn với băng, gạc hoặc vải mềm. Nếu đủ băng, 
                  gạc thì quấn cả chi để trì hoãn nọc độc vào máu.
                  </Text>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image}/>
                  <Text style={styles.semiButtonText}>
                  Cố định toàn chi bị cắn bằng cách bó chi vào nẹp/thanh cứng để hạn chế 
                  tối đa cử động của chi đó.
                  </Text>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image}/>
                  <Text style={styles.semiButtonText}>
                  Bước Nếu có thể, khiêng nạn nhân di chuyển đến cơ sở y tế, không cho phép 
                  nạn nhân tự bước hay di chuyển.
                  </Text>
