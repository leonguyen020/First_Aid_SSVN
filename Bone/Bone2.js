...
class Bone2 extends Component {
    ...
    onPressButtonPlay() {
        if(song == null){
            song = new SoundPlayer('bone2_1.mp3', SoundPlayer.MAIN_BUNDLE, () => {
        ...
        >
              <View style={{justifyContent: 'center', alignItems: 'center'}} onLayout={this.onPressButtonPlay}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/bone2_1.gif')}/>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center'}}>
                <View style={styles.slide1}>
                  <Image style={styles.image} source={require('../GIF/bone2_2.gif')}/>
                  <Text style={styles.semiButtonText}>
